        ...
        this.state = { 
            ...
            navLinks : [
               // { id : 1, title : "Home", link : "/index" },
                // { id : 2, title : "Services", link : "/#", isMegaMenu : true, isOpenSubMenu : false,
                //     child : [
                ...
                //     ]
                // },
                // { id : 3, title : "Pricing", link : "/#", isOpenSubMenu : false,
                //     child : [
                ...
                //     ]
                // },
                // { id : 4, title : "About Us", link : "/#", isOpenSubMenu : false,
                // child : [
        ...
        return (
            <React.Fragment>
                <header id="topnav" className="defaultscroll sticky">
                    <Container>
                        <div>
                            <Link className="logo" to="/index"><img src="favicon.png"></img>&nbsp; SecurityPal<span className="text-primary"></span></Link>
                        </div>
                        <div className="buy-button">
                            <Link to="#" id="buyButton" className="btn btn-primary">Contact Us</Link>
                        </div>
